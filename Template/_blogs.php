            ...
            <div class="owl-carousel owl-theme">
              <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                  ...
                  <p class="card-text font-size-14 text-black-50 py-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe dolorum in modi dolorem aut suscipit facilis dicta dolores architecto deserunt.</p>
                  <a href="" class="color-second text-left">Go somewhare</a>
                </div>
              </div>
              <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
