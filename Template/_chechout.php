...
--> <h2>Checkout form</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1 shadow-lg pb-4">
            ...
            <form class="needs-validation" novalidate="">
                ...
                <div class="d-block my-3">
                    ...
                    <div class="custom-control custom-radio">
                        <input id="debit" name="paymentMethod" value="much" type="radio" class="custom-control-input" required="" onclick="radiodebitCheck();">
                        <label class="custom-control-label" for="debit">Debit card</label>
                    </div>
                   <!-- <div class="custom-control custom-radio">
                        <input id="paypal" name="paymentMethod" type="radio" class="custom-control-input" required="">
                ...
                <div class="border solid pb-3 shadow-lg" id="creditcard" style="display:none;">
                    <div class="pt-2">
